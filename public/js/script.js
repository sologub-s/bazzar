...
(function ($) {
	$.fn.bgIframe = $.fn.bgiframe = function (s) {
		if ($.browser.msie && parseInt($.browser.version) <= 6) {
			s = $.extend({ top: 'auto', left: 'auto', width: 'auto', height: 'auto', opacity: true, src: 'javascript:false;' }, s || {});var prop = function prop(n) {
	    ...
	    s = {};i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = "hide", s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "show", t.widget("ui.accordion", { version: "1.10.2", options: { active: 0, animate: {}, collapsible: !1, event: "click", header: "> li > :first-child,> :not(li):even", heightStyle: "auto", icons: { activeHeader: "ui-icon-triangle-1-s", header: "ui-icon-triangle-1-e" }, activate: null, beforeActivate: null }, _create: function _create() {
			...
			if (!e.altKey && !e.ctrlKey) {
				var i = t.ui.keyCode,
				    ...
				    a = !1;switch (e.keyCode) {case i.RIGHT:case i.DOWN:
						...
						a = this.headers[s - 1];}a && (t(e.target).attr("tabIndex", -1), t(a).attr("tabIndex", 0), a.focus(), e.preventDefault());
			}
			...
			var i,
			    ...
			    o = this.accordionId = "ui-accordion-" + (this.element.attr("id") || ++e);this.active = this._findActive(s.active).addClass("ui-accordion-header-active ui-state-active ui-corner-top").removeClass("ui-corner-all"), this.active.next().addClass("ui-accordion-content-active").show(), this.headers.attr("role", "tab").each(function (e) {
				var i = t(this),
				    s = i.attr("id"),
				    n = i.next(),
				    a = n.attr("id");s || (s = o + "-header-" + e, i.attr("id", s)), a || (a = o + "-panel-" + e, n.attr("id", a)), i.attr("aria-controls", a), n.attr("aria-labelledby", s);
			...
			var i = this.options,
			    ...
			    r = o ? t() : n.next(),
			    h = s.next(),
			    l = { oldHeader: s, oldPanel: h, newHeader: o ? t() : n, newPanel: r };e.preventDefault(), a && !i.collapsible || this._trigger("beforeActivate", e, l) === !1 || (i.active = o ? !1 : this.headers.index(n), this.active = a ? t() : n, this._toggle(l), s.removeClass("ui-accordion-header-active ui-state-active"), i.icons && s.children(".ui-accordion-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header), a || (n.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"), i.icons && n.children(".ui-accordion-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader), n.next().addClass("ui-accordion-content-active")));
			...
			var a,
			    ...
			    p = function p() {
				h._toggleComplete(n);
			};return "number" == typeof d && (r = d), "string" == typeof d && (o = d), o = o || d.easing || u.easing, r = r || d.duration || u.duration, e.length ? t.length ? (a = t.show().outerHeight(), e.animate(i, { duration: r, easing: o, step: function step(t, e) {
					e.now = Math.round(t);
				} }), t.hide().animate(s, { duration: r, easing: o, complete: p, step: function step(t, i) {
...
(function (t, e) {
	function i() {
	    ...
	    a = /#.*$/;t.widget("ui.tabs", { version: "1.10.2", delay: 300, options: { active: null, collapsible: !1, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null }, _create: function _create() {
			var e = this,
			...
			var e = this;this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({ role: "tab", tabIndex: -1 }), this.anchors = this.tabs.map(function () {
				...
				var a,
				    ...
				    l = t(n).closest("li"),
				    u = l.attr("aria-controls");s(n) ? (a = n.hash, o = e.element.find(e._sanitizeSelector(a))) : (r = e._tabId(l), a = "#" + r, o = e.element.find(a), o.length || (o = e._createPanel(r), o.insertAfter(e.panels[i - 1] || e.tablist)), o.attr("aria-live", "polite")), o.length && (e.panels = e.panels.add(o)), u && l.data("ui-tabs-aria-controls", u), l.attr({ "aria-controls": a.substring(1), "aria-labelledby": h }), o.attr("aria-labelledby", h);
			...
			var i = this.options,
			    ...
			    u = { oldTab: s, oldPanel: l, newTab: r ? t() : a, newPanel: h };e.preventDefault(), a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger("beforeActivate", e, u) === !1 || (i.active = r ? !1 : this.tabs.index(a), this.active = o ? t() : a, this.xhr && this.xhr.abort(), l.length || h.length || t.error("jQuery UI Tabs: Mismatching fragment identifier."), h.length && this.load(this.tabs.index(a), e), this._toggle(e, u));
...
Drupal.locale = { 'pluralFormula': function pluralFormula($n) {
		return Number($n % 10 == 1 && $n % 100 != 11 ? 0 : $n % 10 >= 2 && $n % 10 <= 4 && ($n % 100 < 10 || $n % 100 >= 20) ? 1 : 2);
	}, 'strings': { "": { "An AJAX HTTP error occurred.": "\u0412\u043E\u0437\u043D\u0438\u043A\u043B\u0430 AJAX HTTP \u043E\u0448\u0438\u0431\u043A\u0430.", "HTTP Result Code: !status": "\u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043D\u044B\u0439 \u043A\u043E\u0434 HTTP: !status", "An AJAX HTTP request terminated abnormally.": "AJAX HTTP-\u0437\u0430\u043F\u0440\u043E\u0441 \u043D\u0435\u043E\u0436\u0438\u0434\u0430\u043D\u043D\u043E \u0437\u0430\u0432\u0435\u0440\u0448\u0451\u043D.", "Debugging information follows.": "\u0421\u043B\u0435\u0434\u0443\u0435\u0442 \u043E\u0442\u043B\u0430\u0434\u043E\u0447\u043D\u0430\u044F \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F.", "Path: !uri": "\u041F\u0443\u0442\u044C: !uri", "StatusText: !statusText": "\u0422\u0435\u043A\u0441\u0442 \u0421\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u044F: !statusText", "ResponseText: !responseText": "\u0422\u0435\u043A\u0441\u0442 \u041E\u0442\u0432\u0435\u0442\u0430: !responseText", "ReadyState: !readyState": "ReadyState: !readyState", "Hide": "\u0421\u043A\u0440\u044B\u0442\u044C", "Show": "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C", "Configure": "\u041D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C", "(active tab)": "(\u0430\u043A\u0442\u0438\u0432\u043D\u0430\u044F \u0432\u043A\u043B\u0430\u0434\u043A\u0430)", "Select all rows in this table": "\u041E\u0442\u043C\u0435\u0442\u0438\u0442\u044C \u0432\u0441\u0435 \u0441\u0442\u0440\u043E\u043A\u0438 \u0442\u0430\u0431\u043B\u0438\u0446\u044B", "Deselect all rows in this table": "\u0421\u043D\u044F\u0442\u044C \u043E\u0442\u043C\u0435\u0442\u043A\u0443 \u0441\u043E \u0432\u0441\u0435\u0445 \u043A\u043E\u043B\u043E\u043D\u043E\u043A \u0442\u0430\u0431\u043B\u0438\u0446\u044B", "CustomMessage: !customMessage": "\u0421\u043E\u0431\u0441\u0442\u0432\u0435\u043D\u043D\u043E\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435: !customMessage", "This permission is inherited from the authenticated user role.": "\u042D\u0442\u043E \u043F\u0440\u0430\u0432\u043E \u043D\u0430\u0441\u043B\u0435\u0434\u0443\u0435\u0442\u0441\u044F \u043E\u0442 \u0440\u043E\u043B\u0438 \xAB\u0410\u0432\u0442\u043E\u0440\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0439 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C\xBB.", "Done": "\u0413\u043E\u0442\u043E\u0432\u043E", "Customize dashboard": "\u041D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C \u043F\u0430\u043D\u0435\u043B\u044C \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044F" } } };
/*!
...
(function (t, e, i) {
	function o(i, o, n) {
		var r = e.createElement(i);return o && (r.id = te + o), n && (r.style.cssText = n), t(r);
	}function n() {
		return i.innerHeight ? i.innerHeight : t(i).height();
	}function r(t) {
		var e = E.length,
		    i = (j + t) % e;return 0 > i ? e + i : i;
	}function h(t, e) {
		...
		var e,
		    i = t.data(A, Z);null == i ? (_ = t.extend({}, Y), console && console.log && console.log("Error: cboxElement missing settings object")) : _ = t.extend({}, i);for (e in _) {
		...
		var t,
		    ...
		    _n,
		    r = te + "Slideshow_",
		    h = "click." + te;_.slideshow && E[1] ? (e = function e() {
			clearTimeout(t);
		}, i = function i() {
			(_.loop || E[j + 1]) && (t = setTimeout(J.next, _.slideshowSpeed));
		}, o = function o() {
			M.html(_.slideshowStop).unbind(h).one(h, _n), se.bind(ne, i).bind(oe, e).bind(re, _n), x.removeClass(r + "off").addClass(r + "on");
		}, _n = function n() {
			e(), se.unbind(ne, i).unbind(oe, e).unbind(re, _n), M.html(_.slideshowStart).unbind(h).one(h, function () {
				J.next(), o();
			}), x.removeClass(r + "on").addClass(r + "off");
		}, _.slideshowAuto ? o() : _n()) : x.removeClass(r + "off " + r + "on");
	}function f(i) {
		G || (A = i, d(), E = t(A), j = 0, "nofollow" !== _.rel && (E = t("." + ee).filter(function () {
			var e,
			    i = t.data(this, Z);return i && (e = t(this).data("rel") || i.rel || this.rel), e === _.rel;
		...
		function i(t) {
			...
			var e = t.keyCode;$ && _.escKey && 27 === e && (t.preventDefault(), J.close()), $ && _.arrowKey && E[1] && !t.altKey && (37 === e ? (t.preventDefault(), P.click()) : 39 === e && (t.preventDefault(), R.click()));
		...
		var n,
		    ...
		    a,
		    u = J.prep,
		    f = ++de;q = !0, U = !1, A = E[j], d(), c(le), c(oe, _.onLoad), _.h = _.height ? h(_.height, "y") - N - D : _.innerHeight && h(_.innerHeight, "y"), _.w = _.width ? h(_.width, "x") - z - B : _.innerWidth && h(_.innerWidth, "x"), _.mw = _.w, _.mh = _.h, _.maxWidth && (_.mw = h(_.maxWidth, "x") - z - B, _.mw = _.w && _.w < _.mw ? _.w : _.mw), _.maxHeight && (_.mh = h(_.maxHeight, "y") - N - D, _.mh = _.h && _.h < _.mh ? _.h : _.mh), n = _.href, Q = setTimeout(function () {
			L.show();
			...
			var e;f === de && (U.alt = t(A).attr("alt") || t(A).attr("data-alt") || "", _.retinaImage && i.devicePixelRatio > 1 && (U.height = U.height / i.devicePixelRatio, U.width = U.width / i.devicePixelRatio), _.scalePhotos && (r = function r() {
	    ...
	    se = t("<a/>"),
	    ae = "div",
	    de = 0;t.colorbox || (t(p), J = t.fn[Z] = t[Z] = function (e, i) {
		...
		var e;$ && (t = t || {}, t.width && (_.w = h(t.width, "x") - z - B), t.innerWidth && (_.w = h(t.innerWidth, "x")), W.css({ width: _.w }), t.height && (_.h = h(t.height, "y") - N - D), t.innerHeight && (_.h = h(t.innerHeight, "y")), t.innerHeight || t.height || (e = W.scrollTop(), W.css({ height: "auto" }), _.h = W.height()), W.css({ height: _.h }), e && W.scrollTop(e), J.position("none" === _.transition ? 0 : _.speed));
	}, J.prep = function (e) {
		function i() {
			...
			var h,
			    a = "none" === _.transition ? 0 : _.speed;W.empty().remove(), W = o(ae, "LoadedContent").append(e), W.hide().appendTo(F.show()).css({ width: i(), overflow: _.scrolling ? "auto" : "hidden" }).css({ height: n() }).prependTo(v), F.hide(), t(U).css({ "float": "none" }), h = function h() {
				function e() {
				    ...
				    h = E.length,
				    d = "frameBorder",
				    u = "allowTransparency";$ && (n = function n() {
					...
					var e,
					    i,
					    o = E[this],
					    n = t.data(o, Z);n && n.href ? (e = n.href, t.isFunction(e) && (e = e.call(o))) : e = t(o).attr("href"), e && l(n, e) && (e = s(n, e), i = new Image(), i.src = e);
				})) : O.hide(), _.iframe ? (i = o("iframe")[0], d in i && (i[d] = 0), u in i && (i[u] = "true"), _.scrolling || (i.scrolling = "no"), t(i).attr({ src: _.href, name: new Date().getTime(), "class": te + "Iframe", allowFullScreen: !0, webkitAllowFullScreen: !0, mozallowfullscreen: !0 }).one("load", n).appendTo(W), se.one(le, function () {
					i.src = "//about:blank";
...
(function (c) {
	var d = { vertical: false, rtl: false, start: 1, offset: 1, size: null, scroll: 3, visible: null, animation: "normal", easing: "swing", auto: 0, wrap: null, initCallback: null, setupCallback: null, reloadCallback: null, itemLoadCallback: null, itemFirstInCallback: null, itemFirstOutCallback: null, itemLastInCallback: null, itemLastOutCallback: null, itemVisibleInCallback: null, itemVisibleOutCallback: null, animationStepCallback: null, buttonNextHTML: "<div></div>", buttonPrevHTML: "<div></div>", buttonNextEvent: "click", buttonPrevEvent: "click", buttonNextCallback: null, buttonPrevCallback: null, itemFallbackDimension: null },
	    b = false;c(window).bind("load.jcarousel", function () {
		b = true;
	});c.jcarousel = function (l, g) {
		this.options = c.extend({}, d, g || {});this.locked = false;this.autoStopped = false;this.container = null;this.clip = null;this.list = null;this.buttonNext = null;this.buttonPrev = null;this.buttonNextState = null;this.buttonPrevState = null;if (!g || g.rtl === undefined) {
			this.options.rtl = (c(l).attr("dir") || c("html").attr("dir") || "").toLowerCase() == "rtl";
		}this.wh = !this.options.vertical ? "width" : "height";this.lt = !this.options.vertical ? this.options.rtl ? "right" : "left" : "top";var q = "",
		    n = l.className.split(" ");for (var k = 0; k < n.length; k++) {
			if (n[k].indexOf("jcarousel-skin") != -1) {
				c(l).removeClass(n[k]);q = n[k];break;
			}
		}if (l.nodeName.toUpperCase() == "UL" || l.nodeName.toUpperCase() == "OL") {
			this.list = c(l);this.clip = this.list.parents(".jcarousel-clip");this.container = this.list.parents(".jcarousel-container");
		} else {
			this.container = c(l);this.list = this.container.find("ul,ol").eq(0);this.clip = this.container.find(".jcarousel-clip");
		}if (this.clip.size() === 0) {
		...
		}this.buttonPrev = c(".jcarousel-prev", this.container);if (this.buttonPrev.size() === 0 && this.options.buttonPrevHTML !== null) {
			this.buttonPrev = c(this.options.buttonPrevHTML).appendTo(this.container);
		}this.buttonPrev.addClass(this.className("jcarousel-prev"));this.buttonNext = c(".jcarousel-next", this.container);if (this.buttonNext.size() === 0 && this.options.buttonNextHTML !== null) {
		...
		}var m = this.options.visible !== null ? Math.ceil(this.clipping() / this.options.visible) : null;var p = this.list.children("li");var r = this;if (p.size() > 0) {
			var f = 0,
			    h = this.options.offset;p.each(function () {
				r.format(this, h++);f += r.dimension(this, m);
			});this.list.css(this.wh, f + 100 + "px");if (!g || g.size === undefined) {
			...
			this.buttons(false, false);c(window).bind("load.jcarousel", function () {
				r.setup();
			});
		} else {
			this.setup();
		}
	};var a = c.jcarousel;a.fn = a.prototype = { jcarousel: "0.2.9" };a.fn.extend = a.extend = c.extend;a.fn.extend({ setup: function setup() {
			this.first = null;this.last = null;this.prevFirst = null;this.prevLast = null;this.animating = false;this.timer = null;this.resizeTimer = null;this.tail = null;this.inTail = false;if (this.locked) {
				return;
			}this.list.css(this.lt, this.pos(this.options.offset) + "px");var e = this.pos(this.options.start, true);this.prevFirst = this.prevLast = null;this.animate(e, false);c(window).unbind("resize.jcarousel", this.funcResize).bind("resize.jcarousel", this.funcResize);if (this.options.setupCallback !== null) {
			...
			if (this.tail !== null && this.inTail) {
				...
				var g = this;var h = Math.ceil(this.clipping() / this.options.visible),
				    f = 0,
				    e = 0;this.list.children("li").each(function (j) {
					f += g.dimension(this, h);if (parseInt(jQuery(this).attr("jcarouselindex")) < g.first) {
						e = f;
					}
				});this.list.css(this.wh, f + "px");this.list.css(this.lt, -e + "px");
			...
			if (e !== undefined) {
				this.options.size = e;if (!this.locked) {
					this.buttons();
				}
			}return this.options.size;
		}, has: function has(g, h) {
			if (h === undefined || !h) {
				h = g;
			}if (this.options.size !== null && h > this.options.size) {
				h = this.options.size;
			}for (var f = g; f <= h; f++) {
				var k = this.get(f);if (!k.length || k.hasClass("jcarousel-item-placeholder")) {
					return false;
				}
			}return true;
		}, get: function get(e) {
			return c(">.jcarousel-item-" + e, this.list);
		}, add: function add(l, q) {
			var m = this.get(l),
			    h = 0,
			    g = c(q);if (m.length === 0) {
				var p,
				    k = a.intval(l);m = this.create(l);while (true) {
					p = this.get(--k);if (k <= 0 || p.length) {
						if (k <= 0) {
							this.list.prepend(m);
						} else {
							p.after(m);
				...
				m.empty().append(q);
			}this.format(m.removeClass(this.className("jcarousel-item-placeholder")), l);var o = this.options.visible !== null ? Math.ceil(this.clipping() / this.options.visible) : null;var f = this.dimension(m, o) - h;if (l > 0 && l < this.first) {
				this.list.css(this.lt, a.intval(this.list.css(this.lt)) - f + "px");
			}this.list.css(this.wh, a.intval(this.list.css(this.wh)) + f + "px");return m;
		}, remove: function remove(f) {
			var g = this.get(f);if (!g.length || f >= this.first && f <= this.last) {
				return;
			}var h = this.dimension(g);if (f < this.first) {
				this.list.css(this.lt, a.intval(this.list.css(this.lt)) + h + "px");
			}g.remove();this.list.css(this.wh, a.intval(this.list.css(this.wh)) - h + "px");
		}, next: function next() {
			if (this.tail !== null && !this.inTail) {
		...
		}, scrollTail: function scrollTail(e) {
			if (this.locked || this.animating || !this.tail) {
				return;
			}this.pauseAuto();var f = a.intval(this.list.css(this.lt));f = !e ? f - this.tail : f + this.tail;this.inTail = !e;this.prevFirst = this.first;this.prevLast = this.last;this.animate(f);
		}, scroll: function scroll(f, e) {
			if (this.locked || this.animating) {
				return;
			}this.pauseAuto();this.animate(this.pos(f), e);
		}, pos: function pos(C, k) {
			var n = a.intval(this.list.css(this.lt));if (this.locked || this.animating) {
				return n;
			}if (this.options.wrap != "circular") {
				C = C < 1 ? 1 : this.options.size && C > this.options.size ? this.options.size : C;
			}var z = this.first > C;var E = this.options.wrap != "circular" && this.first <= 1 ? 1 : this.first;var H = z ? this.get(E) : this.get(this.last);var B = z ? E : E - 1;var F = null,
			    A = 0,
			    w = false,
			    G = 0,
			    D;while (z ? --B >= C : ++B < C) {
				F = this.get(B);w = !F.length;if (F.length === 0) {
					F = this.create(B).addClass(this.className("jcarousel-item-placeholder"));H[z ? "before" : "after"](F);if (this.first !== null && this.options.wrap == "circular" && this.options.size !== null && (B <= 0 || B > this.options.size)) {
						D = this.get(this.index(B));if (D.length) {
							F = this.add(B, D.clone(true));
						}
					}
				}H = F;G = this.dimension(F);if (w) {
					A += G;
			    ...
			    u = [],
			    h = 0,
			    t = 0;H = this.get(C - 1);B = C;while (++h) {
				F = this.get(B);w = !F.length;if (F.length === 0) {
					F = this.create(B).addClass(this.className("jcarousel-item-placeholder"));if (H.length === 0) {
						this.list.prepend(F);
					} else {
						H[z ? "before" : "after"](F);
				...
				this.list.css(this.wh, this.dimension(this.list) + A + "px");if (z) {
					n -= A;this.list.css(this.lt, a.intval(this.list.css(this.lt)) - A + "px");
				}
			}var q = C + h - 1;if (this.options.wrap != "circular" && this.options.size && q > this.options.size) {
				q = this.options.size;
			}if (B > q) {
				h = 0;B = q;t = 0;while (++h) {
					F = this.get(B--);if (!F.length) {
						break;
					}t += this.dimension(F);if (t >= s) {
						break;
					}
				}
			}var o = q - h + 1;if (this.options.wrap != "circular" && o < 1) {
				o = 1;
			}if (this.inTail && z) {
				n += this.tail;this.inTail = false;
			}this.tail = null;if (this.options.wrap != "circular" && q == this.options.size && q - h + 1 >= 1) {
				var y = a.intval(this.get(q).css(!this.options.vertical ? "marginRight" : "marginBottom"));if (t - y > s) {
					this.tail = t - s - y;
				}
			}if (k && C === this.options.size && this.tail) {
				n -= this.tail;this.inTail = true;
			}while (C-- > o) {
				n += this.dimension(this.get(C));
			}this.prevFirst = this.first;this.prevLast = this.last;this.first = o;this.last = q;return n;
		}, animate: function animate(i, e) {
			if (this.locked || this.animating) {
				return;
			}this.animating = true;var f = this;var g = function g() {
				f.animating = false;if (i === 0) {
					f.list.css(f.lt, 0);
			...
			};this.notify("onBeforeAnimation");if (!this.options.animation || e === false) {
				this.list.css(this.lt, i + "px");g();
			} else {
				var j = !this.options.vertical ? this.options.rtl ? { right: i } : { left: i } : { top: i };var h = { duration: this.options.animation, easing: this.options.easing, complete: g };if (c.isFunction(this.options.animationStepCallback)) {
					h.step = this.options.animationStepCallback;
				}this.list.animate(j, h);
			}
		}, startAuto: function startAuto(f) {
			if (f !== undefined) {
				this.options.auto = f;
				...
				return;
			}this.autoStopped = false;var e = this;this.timer = window.setTimeout(function () {
				e.next();
		...
		}, buttons: function buttons(g, f) {
			if (g == null) {
				g = !this.locked && this.options.size !== 0 && (this.options.wrap && this.options.wrap != "first" || this.options.size === null || this.last < this.options.size);if (!this.locked && (!this.options.wrap || this.options.wrap == "first") && this.options.size !== null && this.last >= this.options.size) {
					g = this.tail !== null && !this.inTail;
				}
			}if (f == null) {
				f = !this.locked && this.options.size !== 0 && (this.options.wrap && this.options.wrap != "last" || this.first > 1);if (!this.locked && (!this.options.wrap || this.options.wrap == "last") && this.options.size !== null && this.first == 1) {
					f = this.tail !== null && this.inTail;
				}
			}var e = this;if (this.buttonNext.size() > 0) {
				this.buttonNext.unbind(this.options.buttonNextEvent + ".jcarousel", this.funcNext);if (g) {
					this.buttonNext.bind(this.options.buttonNextEvent + ".jcarousel", this.funcNext);
				}this.buttonNext[g ? "removeClass" : "addClass"](this.className("jcarousel-next-disabled")).attr("disabled", g ? false : true);if (this.options.buttonNextCallback !== null && this.buttonNext.data("jcarouselstate") != g) {
				...
				this.buttonPrev.unbind(this.options.buttonPrevEvent + ".jcarousel", this.funcPrev);if (f) {
					this.buttonPrev.bind(this.options.buttonPrevEvent + ".jcarousel", this.funcPrev);
				}this.buttonPrev[f ? "removeClass" : "addClass"](this.className("jcarousel-prev-disabled")).attr("disabled", f ? false : true);if (this.options.buttonPrevCallback !== null && this.buttonPrev.data("jcarouselstate") != f) {
			...
			}this.buttonNextState = g;this.buttonPrevState = f;
		}, notify: function notify(e) {
			var f = this.prevFirst === null ? "init" : this.prevFirst < this.first ? "next" : "prev";this.callback("itemLoadCallback", e, f);if (this.prevFirst !== this.first) {
				this.callback("itemFirstInCallback", e, f, this.first);this.callback("itemFirstOutCallback", e, f, this.prevFirst);
			}if (this.prevLast !== this.last) {
				this.callback("itemLastInCallback", e, f, this.last);this.callback("itemLastOutCallback", e, f, this.prevLast);
			}this.callback("itemVisibleInCallback", e, f, this.first, this.last, this.prevFirst, this.prevLast);this.callback("itemVisibleOutCallback", e, f, this.prevFirst, this.prevLast, this.first, this.last);
		}, callback: function callback(j, m, e, k, h, g, f) {
			if (this.options[j] == null || _typeof(this.options[j]) != "object" && m != "onAfterAnimation") {
				return;
			}var n = _typeof(this.options[j]) == "object" ? this.options[j][m] : this.options[j];if (!c.isFunction(n)) {
				return;
			}var o = this;if (k === undefined) {
				n(o, e, m);
			} else {
				if (h === undefined) {
		...
		}, format: function format(k, h) {
			k = c(k);var g = k.get(0).className.split(" ");for (var f = 0; f < g.length; f++) {
				if (g[f].indexOf("jcarousel-") != -1) {
					k.removeClass(g[f]);
				}
			}k.addClass(this.className("jcarousel-item")).addClass(this.className("jcarousel-item-" + h)).css({ "float": this.options.rtl ? "right" : "left", "list-style": "none" }).attr("jcarouselindex", h);return k;
		}, className: function className(e) {
			return e + " " + e + (!this.options.vertical ? "-horizontal" : "-vertical");
		}, dimension: function dimension(h, i) {
			var g = c(h);if (i == null) {
				...
				var f = !this.options.vertical ? i - a.intval(g.css("marginLeft")) - a.intval(g.css("marginRight")) : i - a.intval(g.css("marginTop")) - a.intval(g.css("marginBottom"));c(g).css(this.wh, f + "px");return this.dimension(g);
			}
		...
		}, index: function index(e, f) {
			if (f == null) {
				f = this.options.size;
			}return Math.round(((e - 1) / f - Math.floor((e - 1) / f)) * f) + 1;
		} });a.extend({ defaults: function defaults(e) {
			return c.extend(d, e || {});
		}, intval: function intval(e) {
			e = parseInt(e, 10);return isNaN(e) ? 0 : e;
		}, windowLoaded: function windowLoaded() {
			b = true;
		}, isSafari: function isSafari() {
			var g = navigator.userAgent.toLowerCase(),
			    f = /(chrome)[ \/]([\w.]+)/.exec(g) || /(webkit)[ \/]([\w.]+)/.exec(g) || [],
			    e = f[1] || "";return e === "webkit";
		} });c.fn.jcarousel = function (g) {
		if (typeof g == "string") {
			var e = c(this).data("jcarousel"),
			    f = Array.prototype.slice.call(arguments, 1);return e[g].apply(e, f);
		} else {
			return this.each(function () {
				var h = c(this).data("jcarousel");if (h) {
					if (g) {
...
(function ($) {
  ...
  */
	var toggler_click = function toggler_click() {
  ...
  */
	function store_classes_ids(menuElement) {
		...
		$(menuElement).data('removeattr', true).data('rmids', $(menuElement).attr('id')).data('rmclasses', $(menuElement).attr('class'));
		...
		$(menuElement).find('ul').each(function () {
			...
			$(this).data('removeattr', true).data('rmids', $(this).attr('id')).data('rmclasses', $(this).attr('class'));
		});
...
var FORMALIZE = function ($, window, document, undefined) {
	...
	return {
		...
		init: {
			...
			ie6_skin_inputs: function ie6_skin_inputs() {
		...
		misc: {
			// FORMALIZE.misc.add_placeholder
			add_placeholder: function add_placeholder() {
				if (PLACEHOLDER_SUPPORTED || !$(':input[placeholder]').length) {
					// Exit if placeholder is supported natively,
					// or if page does not have any placeholder.
					return;
...
(function ($) {
  ...
  * @todo
  */
	var setCurrentLayout = function setCurrentLayout(index) {
...
(function ($) {
	Drupal.behaviors.addthis = {
		...
		isSettingsLoaded: function isSettingsLoaded() {
		...
		loadDomready: function loadDomready() {
		...
		ajaxLoad: function ajaxLoad(context, settings) {
...
/**
 * Created by zeitgeist on 12/4/17.
 */
...
jQuery.extend(Drupal.settings, {
	...
	"ajaxPageState": {
		"theme": "quatro",
		"theme_token": "Wuow3NVVZYAnYG_M1049nBE1Qj9c7vvYVUsqnqm4Bxg",
		"js": {
			...
			"public:\/\/languages\/ru_rfvRusY_ByZmBNfd8z1iVQ1tIIFfQxmVhFV4gKl1a7c.js": 1,
			...
			"sites\/all\/themes\/quatro\/js\/custom.js": 1
		},
		"css": {
			...
			"sites\/all\/themes\/quatro\/css\/quatro-reset.css": 1,
			"sites\/all\/themes\/quatro\/css\/global.css": 1,
			"sites\/all\/themes\/quatro\/css\/purple-style.css": 1,
			"ie::normal::sites\/all\/themes\/quatro\/css\/quatro-alpha-default.css": 1,
			"ie::normal::sites\/all\/themes\/quatro\/css\/quatro-alpha-default-normal.css": 1,
			"ie::normal::sites\/all\/themes\/omega\/alpha\/css\/grid\/alpha_default\/normal\/alpha-default-normal-16.css": 1,
			"normal::sites\/all\/themes\/quatro\/css\/quatro-alpha-default.css": 1,
			"normal::sites\/all\/themes\/quatro\/css\/quatro-alpha-default-normal.css": 1,
			"sites\/all\/themes\/omega\/alpha\/css\/grid\/alpha_default\/normal\/alpha-default-normal-16.css": 1,
			"wide::sites\/all\/themes\/quatro\/css\/quatro-alpha-default.css": 1,
			"wide::sites\/all\/themes\/quatro\/css\/quatro-alpha-default-wide.css": 1,
			"sites\/all\/themes\/omega\/alpha\/css\/grid\/alpha_default\/wide\/alpha-default-wide-16.css": 1
		}
	},
	"colorbox": {
		"opacity": "0.85",
	...
	"jcarousel": {
		...
		"carousels": {
			"jcarousel-dom-1": {
				"view_options": {
					"view_args": "",
					"view_path": "front-page",
					"view_base_path": "video",
